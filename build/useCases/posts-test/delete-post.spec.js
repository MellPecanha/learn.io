...
// src/useCases/posts-test/delete-post.spec.ts
describe("Delete Post Use Case", () => {
  ...
  it("deve ser poss\xEDvel deletar um post existente como PROFESSOR", async () => {
    await sut.execute(1, "PROFESSOR" /* PROFESSOR */);
    globalExpect(postsRepository.items).toHaveLength(0);
  });
  it("n\xE3o deve ser poss\xEDvel deletar um post como ALUNO", async () => {
    await globalExpect(() => sut.execute(1, "ALUNO" /* ALUNO */)).rejects.toBeInstanceOf(
      UnauthorizedError
    );
  });
  it("n\xE3o deve ser poss\xEDvel deletar um post inexistente", async () => {
    await globalExpect(
      () => sut.execute(999, "PROFESSOR" /* PROFESSOR */)
